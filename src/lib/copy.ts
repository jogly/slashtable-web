...
export const DOWNLOAD = {
  ...
  linuxHint: "alpha · Debian/Ubuntu, amd64",
  linuxInstall: "sudo apt-get install ./SlashTable_*_amd64.deb",
...
export const DOWNLOAD_PAGE = {
  ...
  platformTag: "macOS",
  platformTagLinux: "macOS + Linux (alpha)",
  loading: "Checking\u2026",
  unavailable: "Release feed unavailable",
  viewChangelog: "View changelog",
  archHeading: "Pick your architecture",
  buildsAvailable: (n: number) => `${n} build${n === 1 ? "" : "s"} available`,
  recommendedBadge: "Detected Mac",
  recommendedBadgeLinux: "Detected Linux",
  alsoAvailable: "Also available",
  downloadCta: "Download .dmg",
  downloadCtaLinux: "Download .deb",
  silicon: {
    label: "Apple Silicon",
    arch: "aarch64",
    body: "M-series Macs",
  ...
  linuxPlatform: {
    ...
    label: "Linux",
    badge: "alpha",
    body: "Debian/Ubuntu, amd64.",
    cta: "Download .deb",
    install: "sudo apt-get install ./SlashTable_*_amd64.deb",
  },
  requirementsHeading: "System requirements",
  requirements: [
    { label: "Operating system", value: ["macOS 12.0 Monterey or later", "Debian/Ubuntu (alpha)"] },
    { label: "Architecture", value: ["Apple Silicon or Intel", "Linux amd64"] },
  ...
  intelColumn: "Intel",
  linuxX86Column: "Linux x86",
  linuxAmd64Column: "Linux amd64",
  linuxColumn: "Linux (alpha)",
  macosGroup: "macOS",
  linuxGroup: "Linux (alpha)",
  archAarch64: "aarch64",
  archX64: "x86_64",
  archAmd64: "amd64",
  latestBadge: "Latest",
