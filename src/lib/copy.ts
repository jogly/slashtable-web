...
export const HERO = {
  ...
  availabilityLinux: "macOS \u00b7 Linux \u00b7 Postgres \u00b7 MySQL \u00b7 SQLite \u00b7 Neon",
  screenshotAlt:
...
export const DOWNLOAD = {
  ...
  downloadLabelLinux: "Download for Linux",
  linuxHint: "Debian/Ubuntu, amd64",
...
export const DOWNLOAD_PAGE = {
  ...
  recommendedBadgeLinux: "Detected for your Linux",
  ...
  linux: {
    label: "Linux",
    arch: "amd64",
    body: "Debian/Ubuntu, x86_64",
  },
  requirementsHeading: "System requirements",
  requirements: [
    { label: "Operating system", value: ["macOS 12.0 Monterey or later", "Debian/Ubuntu"] },
    { label: "Architecture", value: ["Apple Silicon or Intel", "Linux amd64 / x86_64"] },
