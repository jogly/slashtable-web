    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 z-[90] w-full border-t border-border shadow-xl sm:bottom-5 sm:left-5 sm:w-lg sm:rounded-lg sm:border"
        >
          ...
          <div className="absolute inset-0 bg-surface/80 sm:bg-surface/50 sm:rounded-lg" />
          ...
          <div className="relative p-4 sm:p-5">
            ...
            <div className="sm:max-w-[76%]">
              <p className="pr-6 font-medium text-sm text-text leading-snug sm:pr-0">
                {COOKIE_CONSENT.heading}
              </p>
              <p className="mt-2 text-[13px] text-text/80 leading-relaxed">
                {COOKIE_CONSENT.body}
              </p>
              <p className="mt-1.5 hidden text-[11px] text-text/50 italic leading-relaxed sm:block">
                {COOKIE_CONSENT.aside}
              </p>
