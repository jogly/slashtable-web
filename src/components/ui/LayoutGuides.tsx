  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0">
      <div className="relative mx-auto h-full max-w-content">
        <div className="absolute inset-y-0 left-0 border-transparent border-l border-dashed min-[68rem]:border-border min-[68rem]:in-data-[theme=light]:border-border" />
        <div className="absolute inset-y-0 right-0 border-transparent border-r border-dashed min-[68rem]:border-border min-[68rem]:in-data-[theme=light]:border-border" />
      </div>
    </div>
  );
}
