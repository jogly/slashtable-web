  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Email form */}
        {submitted ? (
          <p className="mt-6 font-mono text-[11px] text-green uppercase tracking-widest">
            {THANK_YOU.emailSuccess}
          </p>
        ) : (
          <form onSubmit={handleSubmit} className="mt-6 flex gap-2">
            ...
            <button
              type="submit"
              className="shrink-0 rounded bg-accent px-4 py-2 font-mono text-xs text-black uppercase tracking-widest transition-colors hover:bg-white"
            >
