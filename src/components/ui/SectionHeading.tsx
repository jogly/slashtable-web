...
export function SectionHeading({ eyebrow, children, description, className, align = "center" }: SectionHeadingProps) {
  return (
    <div className={cn("mb-12 lg:mb-16", align === "center" && "text-center", className)}>
      ...
      <h2 className="font-semibold text-3xl text-text tracking-tight lg:text-4xl">{children}</h2>
      {description && (
