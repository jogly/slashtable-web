        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <FadeIn delay={0.12} className="order-last lg:order-first">
            <div className="border border-border bg-background p-6 lg:p-8">
              <p className="mb-4 font-mono text-[10px] text-text-muted uppercase tracking-widest">{FILTERING.operatorsLabel}</p>
          ...
          <FadeIn>
            <div className="mb-5 flex items-center gap-2">
              ...
              <span className="font-mono text-[10px] text-text-muted uppercase tracking-widest">{FILTERING.eyebrow}</span>
            </div>
            ...
            <div className="mt-6 space-y-4 text-text-secondary leading-relaxed">
              ...
              <p>
                {FILTERING.body[2].split(/(in list|between)/).map((part, i) =>
                  part === "in list" || part === "between" ? (
                    <span key={i} className="font-mono text-sm text-text">{part}</span>
                  ) : (
