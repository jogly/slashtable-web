    ...
    <section className="border-border border-y bg-surface">
      <div className="mx-auto flex max-w-[68rem] flex-col items-center gap-4 px-6 py-6 sm:flex-row sm:justify-center sm:gap-6">
        <div className="flex items-center gap-3">
          ...
          <p className="font-mono text-[10px] text-text-muted uppercase tracking-widest">Early Access</p>
        ...
        <a
          ...
          className="inline-flex items-center rounded-full border border-border-strong px-4 py-1.5 font-mono text-[10px] text-text-secondary uppercase tracking-widest transition-colors hover:border-white hover:text-white"
        >
          Buy me a coffee
        </a>
      </div>
